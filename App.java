...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (Map<String,String> filme : listaDeFilmes) {
            System.out.println("\u001b[1m\u001b[4mPosição:\u001b[m " + filme.get("rank"));
            System.out.println("\u001b[1m\u001b[4mFilme:\u001b[m " + filme.get("title"));
            System.out.println("\u001b[1m\u001b[4mPoster:\u001b[m " + filme.get("image"));
            System.out.println("\u001b[1m\u001b[4mNota:\u001b[m " + filme.get("imDbRating"));
